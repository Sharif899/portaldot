...
const MOCK_PROOFS = [
  {
    ...
    assetName:   "Lagos Apartment Block A — LAGO",
    status:      "Verified",
    hash:        "a3f8e9b2c1d4...7f2e",
    submittedAt: "2026-05-01",
    verifiedAt:  "2026-05-02",
    verifier:    "5FHneW...d1Hi",
  },
  {
    assetId:     "5GrwDEF...5678",
    assetName:   "Abuja Commercial Plaza Unit 5 — ACP5",
    status:      "Verified",
    hash:        "b7c2d5e8f1a3...9c4d",
  ...
  },
  {
    ...
    assetName:   "Cocoa Export Batch #2026-04",
    status:      "Verified",
    hash:        "d4e5f6a7b8c9...2e3f",
    submittedAt: "2026-05-05",
    verifiedAt:  "2026-05-06",
    verifier:    "5FHneW...d1Hi",
  },
  {
    assetId:     "5GrwJKL...3456",
    assetName:   "Trade Invoice — Zenith Supplies",
    status:      "Pending",
    hash:        "c9d3e6f2a8b5...1d7e",
        ...
        <main style={{ flex: 1, padding: "32px", overflowY: "auto", background: "var(--bg-base)" }}>
          ...
          <div style={{
            ...
            <p style={{ fontSize: "13px", color: "var(--text-secondary)", margin: 0, lineHeight: 1.6 }}>
              ...
              of your legal document is stored on-chain. This proves the document exists and hasn't
              changed — without revealing its contents. Investors verify the hash before buying fractions.
            </p>
          </div>
            ...
            <div>
              ...
              {tab === "verify" && (
                <div style={{
                  ...
                  {/* Quick select — only shown if user has tokenized assets */}
                  {myAssets.length > 0 && (
              ...
              {tab === "submit" && (
                <div style={{
                  ...
                  {submitted ? (
                    ...
                    <>
                      {/* Quick select from tokenized assets */}
                      {myAssets.length > 0 && (
                        <div style={{ marginBottom: "14px" }}>
                          <label style={{
                            fontSize:     "13px",
